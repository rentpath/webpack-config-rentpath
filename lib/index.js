...
var config = {
  ...
  module: {
    loaders: [{
      ...
      loader: ExtractTextPlugin.extract('css?sourceMap!resolve-url!sass?sourceMap') }, { test: /\.css$/, loader: ExtractTextPlugin.extract('css?sourceMap!resolve-url') }, { test: /\.hbs$/, loader: 'handlebars-loader' }, { test: /\.svg$/, loader: 'file?hash=sha512&digest=hex&name=[name]-[hash].svg' }, imageLoader()]
  },
  resolve: {
